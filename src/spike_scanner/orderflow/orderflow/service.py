...
class OrderflowMonitor:
    ...
    def measure(self, context: ScannerContext, depth: int = 10) -> OrderflowMeasurement:
        try:
            book = self.provider.get_order_book(context.symbol, depth=depth)
    ...
    def measure_latest_top(self, limit: int = 10, depth: int = 10) -> list[OrderflowMeasurement]:
